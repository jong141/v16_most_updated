...
import 'TPP (perpendicular) 1.dart';

import 'package:mathv15/main_page/calculation%20formula%20page/variables.dart';


class choose_TPP_perpendicular_page extends StatefulWidget {
  const choose_TPP_perpendicular_page({Key? key}) : super(key: key);
  @override
  State<choose_TPP_perpendicular_page> createState() => _choose_TPP_perpendicular_pageState();
}

class _choose_TPP_perpendicular_pageState extends State<choose_TPP_perpendicular_page> {
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          'Fresnel Equation \n Transmission Perpendicular Polarization ',
