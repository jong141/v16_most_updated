...
class brewster_angle_eq1 extends StatelessWidget {
  final variables = Variables();

  brewster_angle_eq1({
    required er_display, required er2_display,required E1_display, required E2_display,
    required Et_display, required root_display,required BA1_display,
  });
                  ...
                  child: Column(
                    children: [
                      ...
                      FittedBox(
                        fit: BoxFit.fitWidth,
                        child: Math.tex(
                          r'\tan\theta_{B||} = \sqrt \frac{\varepsilon_2}{\varepsilon_1}',
                      ...
                      FittedBox(
                        fit: BoxFit.fitWidth,
                        child: Math.tex(
                          r'\theta_{B||} =' +variables.BA1_display,
                          textStyle: const TextStyle(fontSize: 25),
                        ),
                      ),
                      const SizedBox( height: 25),
                            ...
                            children: [
                              ListTile(
                                title: FittedBox(
                                  alignment: FractionalOffset.centerLeft,
                                  fit: BoxFit.scaleDown,
                                  child: Math.tex(r'\large\theta_{B\Vert}\normalsize=' +variables.BA1_display, textStyle: const TextStyle(fontSize: 18),),),),
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                      child: Math.tex(r'\large\theta_{B\Vert}\normalsize = \large\tan^{-1}\sqrt\frac{\varepsilon_2}{\varepsilon_1}', textStyle: const TextStyle(fontSize: 18),),),),
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                  ...
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                      child: Math.tex(r'\ \ \ \ \ = ' +variables.BA1_display, textStyle: const TextStyle(fontSize: 18),),),),
                                ],
                              ),
                            ],
                          ),
