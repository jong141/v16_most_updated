...
import 'RPP (parallel) 1.dart';

import 'package:mathv15/main_page/calculation%20formula%20page/variables.dart';


class choose_RPP_parallel_page extends StatefulWidget {
  const choose_RPP_parallel_page({Key? key}) : super(key: key);
  @override
  State<choose_RPP_parallel_page> createState() => _choose_RPP_parallel_pageState();
}

class _choose_RPP_parallel_pageState extends State<choose_RPP_parallel_page> {
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          'Fresnel Equation \n Reflection Parallel Polarization',
