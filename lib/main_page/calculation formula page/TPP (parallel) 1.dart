...
class TPP_parallel_1 extends StatelessWidget {
  final variables = Variables();

  TPP_parallel_1({
    required theta_i_display, required theta_t_display,required CII_1_real_display, required CII_1_im_display,
    required CII_1_R_display, required CII_1_angle_display,required CII_2_real_display, required CII_2_im_display,
    required CII_2_R_display, required CII_2_angle_display,required n1_cos_i_r_display, required n1_cos_i_angle_display,
    required n1_cos_i_real_display, required n1_cos_i_im_display,required n2_cos_t_r_display, required n2_cos_t_angle_display,
    required n2_cos_t_real_display, required n2_cos_t_im_display,required n2_cos_i_r_display, required n2_cos_i_angle_display,
    required n2_cos_i_real_display, required n2_cos_i_im_display,required two_n2cosi_re_display, required two_n2cosi_im_display,
    ...
    required r_per_real_display, required r_per_im_display,
  });
                ...
                child: Column(
                  children: [
                    ...
                    FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Math.tex(
                        r'\tau{_{//}} =' +variables.r_per_real_display +r'+' +variables.r_per_im_display  +r'j',
                        textStyle: const TextStyle(fontSize: 25),
                      ),
                    ),
                    const SizedBox( height: 25),
                          ...
                          children: [
                            ...
                            ExpansionTile(
                              title: Text("More Details:",
                                style: TextStyle(color: Colors.black, fontSize: 20,),),
                              children: [
                                two_n2cosi_2(variables.CII_1_real_display,variables.CII_1_im_display,variables.CII_2_real_display, variables.CII_2_im_display , variables.n1_cos_t_r_display ,
                                variables.n1_cos_t_angle_display , variables.n1_cos_t_real_display , variables.n1_cos_t_im_display , variables.n2_cos_t_r_display , variables.n2_cos_i_angle_display ,
                                ...
                                variables.CII_1_angle_display, variables.CII_2_R_display, variables.CII_2_angle_display, variables.theta_i_display, variables.theta_t_display, variables.n2_cos_i_r_display ),
                              ],
                            ),
                          ],
                        ),
                              ...
                              children: [
                                ListTile(
                                  title: FittedBox(
                                    alignment: FractionalOffset.centerLeft,
                                    fit: BoxFit.scaleDown,
                                    child: Math.tex(r'\large\tau{_{//}} = \frac {2\eta_2\cos(\theta_i)}{\eta_2\cos(\theta_i)+\eta_1\cos(\theta_t)}', textStyle: const TextStyle(fontSize: 18),),),),
                                ListTile(
                                  title: FittedBox(
                                    alignment: FractionalOffset.centerLeft,
                                    fit: BoxFit.scaleDown,
