...
class RPP_perpendicular_1 extends StatelessWidget {
  ...
  RPP_perpendicular_1({
    ...
    required n1_cos_t_real_display, required n1_cos_t_im_display,required top_part_re_display, required top_part_im_display,
                ...
                child: Column(
                  children: [
                    ...
                    FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Math.tex(
                        r'\varGamma{_\perp} =' +variables.r_per_real_display +r'+' +variables.r_per_im_display  +r'j',
                        textStyle: const TextStyle(fontSize: 25),
                      ),
                    ),
                    const SizedBox( height: 25),
                          ...
                          children: [
                            ...
                            ExpansionTile(
                              title: Text("More Details:",
                                style: TextStyle(color: Colors.black, fontSize: 20,),),
                              children: [
                                n2cosi_minus_n1cost(variables.CII_1_real_display,variables.CII_1_im_display,variables.CII_2_real_display, variables.CII_2_im_display , variables.n1_cos_t_r_display ,
                                  variables.n1_cos_t_angle_display , variables.n1_cos_t_real_display , variables.n1_cos_t_im_display , variables.n2_cos_i_r_display , variables.n2_cos_i_angle_display ,
                                  variables.n2_cos_i_real_display ,variables.n2_cos_i_im_display ,variables.top_part_re_display , variables.top_part_im_display , variables.top_part_r_display ,
                              ...
                              children: [
                                ListTile(
                                  title: FittedBox(
                                    alignment: FractionalOffset.centerLeft,
                                    fit: BoxFit.scaleDown,
                                    child: Math.tex(r'\large\varGamma{_\perp} = \frac {\eta_2\cos(\theta_i)-\eta_1\cos(\theta_t)}{\eta_2\cos(\theta_i)+\eta_1\cos(\theta_t)}', textStyle: const TextStyle(fontSize: 18),),),),
                                ListTile(
                                  title: FittedBox(
                                    alignment: FractionalOffset.centerLeft,
                                    fit: BoxFit.scaleDown,
