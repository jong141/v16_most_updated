...
class t_snell_law_eq1 extends StatelessWidget {
  final variables = Variables();

  t_snell_law_eq1({
    required er_display, required er2_display,required E1_display, required E2_display,
    required theta_i_display, required mu_display,required mu2_display, required U1_display,
    required U2_display, required UE1_display,required UE2_display, required UEt_display,
    required root_3_display, required sin_t_display,required sin_i_display, required Tsnell1_display,
                ...
                child: Container(
                  ...
                  children: [
                    ...
                    FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Math.tex(
                        r'\theta_t =' +variables.Tsnell1_display,
                        textStyle: const TextStyle(fontSize: 25),
                      ),
                    ),
                      const SizedBox( height: 25),
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              ListTile(
                                title: FittedBox(
                                  alignment: FractionalOffset.centerLeft,
                                  fit: BoxFit.scaleDown,
                                  child: Math.tex(r'\large\mu_{\scriptsize 2\normalsize r} \normalsize='+variables.mu2_display, textStyle: const TextStyle(fontSize: 20),),),),
                              ListTile(
                                title: FittedBox(
                                  alignment: FractionalOffset.centerLeft,
                                  fit: BoxFit.scaleDown,
                                  child: Math.tex(r'\large\theta_i\normalsize =' +variables.theta_i_display, textStyle: const TextStyle(fontSize: 20),),),),
                            ],
                          ),
                          ExpansionTile(
                            title: Text("Step 1:",
                              style: TextStyle(color: Colors.black, fontSize: 20,),),
                            children: [
                              ListTile(title: Math.tex(r'\large\frac{\mu_1\varepsilon_1}{\mu_2\varepsilon_2}\normalsize=' +variables.UEt_display, textStyle: const TextStyle(fontSize: 18))),
                              ExpansionTile(
                          ...
                          ExpansionTile(
                            title: Text("Step 3:",
                              style: TextStyle(color: Colors.black, fontSize: 20,),),
                            children: [
                              ListTile(title: Math.tex(r'\large\theta_t\normalsize=' +variables.Tsnell1_display,textStyle:const TextStyle(fontSize:18))),
                              ExpansionTile(
                                title: Text("More Details:",
                                  style: TextStyle(color: Colors.black, fontSize: 20,),),
                                children: [
                                  ListTile(title: Math.tex(r'\large\theta_i\normalsize =' +variables.theta_i_display, textStyle: const TextStyle(fontSize: 18))),
                                  ListTile(title: Math.tex(r'\large\sin\theta_i\normalsize =\large\sin\normalsize(' +variables.theta_i_display +r')', textStyle: const TextStyle(fontSize: 18))),
                                  ListTile(title: Math.tex(r'\ \ \ \ \ \ \ \ \ \ \ = ' +variables.sin_i_display, textStyle: TextStyle(fontSize: 18))),
                                  ListTile(title: Text.rich(TextSpan(text: '________________________________', style: TextStyle(fontSize: 18)))),
                                  ListTile(title: Math.tex(r'\large\frac {\sin\theta_t}{\sin\theta_i}\normalsize = \large\sqrt \frac{\mu_1\varepsilon_1}{\mu_2\varepsilon_2}', textStyle: const TextStyle(fontSize: 18))),
                                  ListTile(title: Math.tex(r'\large\frac {\sin\theta_t }{\normalsize' +variables.sin_i_display +r'}\normalsize =' +variables.root_3_display, textStyle: const TextStyle(fontSize: 18))),

                                  ListTile(title: Math.tex(r'\large\sin\theta_t\normalsize = (' +variables.sin_t_display +r')*(' +variables.root_3_display +r')', textStyle: const TextStyle(fontSize: 18))),
                                  ListTile(title: Math.tex(r'\large\sin\theta_t\normalsize = ' +variables.sin_t_display , textStyle: const TextStyle(fontSize: 18))),
                                  ListTile(title: Math.tex(r'\large\theta_i\normalsize = \large\sin^{-1}\normalsize(' +variables.sin_t_display +r')' ,textStyle:const TextStyle(fontSize:18))),
                                  ListTile(title: Math.tex(r'\large\theta_i\normalsize=' +variables.Tsnell1_display,textStyle:const TextStyle(fontSize:18))),
                                  ...
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                      child: Math.tex(r'\ \ \ \ \ \ \ \ \ \ \ = ' +variables.sin_i_display, textStyle: const TextStyle(fontSize: 18),),),),
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                  ...
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                      child: Math.tex(r'\large\frac {\sin\theta_t }{\normalsize' +variables.sin_i_display +r'}\normalsize =' +variables.root_3_display, textStyle: const TextStyle(fontSize: 18),),),),
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
                                      child: Math.tex(r'\large\sin\theta_t\normalsize = (' +variables.sin_i_display+r')*(' +variables.root_3_display +r')', textStyle: const TextStyle(fontSize: 18),),),),
                                  ListTile(
                                    title: FittedBox(
                                      alignment: FractionalOffset.centerLeft,
                                      fit: BoxFit.scaleDown,
